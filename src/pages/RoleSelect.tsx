...
export default function RoleSelect() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-blue-50 to-white px-6">
      <Seo
        title="Sellizi — Buy & Sell Digital Products in Africa"
        description="Sellizi is a digital marketplace for courses, accounts, digital downloads and services across Africa. Pay securely with Mobile Money."
        path="/"
      />
